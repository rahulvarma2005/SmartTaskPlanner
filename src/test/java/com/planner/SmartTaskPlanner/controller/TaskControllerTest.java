...
public class TaskControllerTest {
    ...
    public void testGenerateTasks() throws Exception {
        ...
        // Prepare sample TaskResponse list
        TaskResponse task1 = new TaskResponse();
        task1.setId(1L);
        task1.setTaskDescription("Set up Spring Boot project with deadline 2024-01-15");
        task1.setDeadline(LocalDate.of(2024, 1, 15));
        task1.setStatus("To Do");

        TaskResponse task2 = new TaskResponse();
        task2.setId(2L);
        task2.setTaskDescription("Learn Spring Boot basics with deadline 2024-01-20");
        task2.setDeadline(LocalDate.of(2024, 1, 20));
        ...
        mockMvc.perform(post("/api/tasks/generate")
                ...
                .andExpect(jsonPath("$[0].taskDescription").value("Set up Spring Boot project with deadline 2024-01-15"))
                .andExpect(jsonPath("$[0].status").value("To Do"))
                .andExpect(jsonPath("$[1].id").value(2))
                .andExpect(jsonPath("$[1].taskDescription").value("Learn Spring Boot basics with deadline 2024-01-20"))
